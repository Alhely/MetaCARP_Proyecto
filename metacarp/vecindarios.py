...
def generar_vecino_ids(
    ...
    *,
    ...
    pesos_operadores: Sequence[float] | None = None,   # Pesos para rng.choices(); None = uniforme
    ...
    while True:
        ...
        op = rng.choices(ops, weights=pesos_operadores, k=1)[0] if pesos_operadores is not None else rng.choice(ops)
