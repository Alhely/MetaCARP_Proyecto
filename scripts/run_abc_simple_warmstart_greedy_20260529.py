"""
Experimento warmstart_greedy_20260529 para ABC Simple.
...
SUBCARPETA      = "warmstart_greedy_20260529_abc_simple"
EXPERIMENTO_TAG = "abc_simple_warmstart_greedy"


def _ejecutar_una(tarea: TareaExp) -> tuple[TareaExp, str, dict | None, str | None]:
    """Worker: una corrida de ABC Simple con PS warmstart + evaluador greedy."""
    try:
        aplicar_patches_warmstart_greedy(
            MODULO_MH,
            p_pr=P_PR,
...
def main() -> None:
    correr_grid(
        ...
        descripcion_cli=(
            "warmstart_greedy_20260529 para ABC: Path-Scanning warmstart + "
