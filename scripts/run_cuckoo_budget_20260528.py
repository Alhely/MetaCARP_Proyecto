"""
Experimento budget_20260528 para Cuckoo Search.
...
PREFIJO_CSV     = "cuckoo"
SUBCARPETA      = "budget_20260528_cuckoo"
EXPERIMENTO_TAG = "cuckoo_budget"


def _ejecutar_una(tarea: TareaExp) -> tuple[TareaExp, str, dict | None, str | None]:
    """Worker: una corrida de Cuckoo Search con presupuesto x10 y lambda x10."""
    try:
...
def main() -> None:
    correr_grid(
        ...
        descripcion_cli=(
            "budget_20260528 para Cuckoo: factor_iter=10, "
