"""
Variante experimental path_relinking_20260528 para Reactive Tabu Search (RTS).
...
Cambios vs. ``run_tabu_reactiva_strict_intra_inter_20260524.py``:
  ...
  5. **Salida**: ``experimentos/path_relinking_20260528_tabu_reactiva/``.
"""
...
SUBCARPETA      = "path_relinking_20260528_tabu_reactiva"
EXPERIMENTO_TAG = "tabu_reactiva_path_relinking"


def _ejecutar_una(tarea: TareaExp) -> tuple[TareaExp, str, dict | None, str | None]:
    """Worker: una corrida de RTS con la politica experimental PR."""
    try:
...
def main() -> None:
    correr_grid(
        ...
        descripcion_cli=(
            "Variante experimental path_relinking_20260528 para RTS: "
