"""
Variante experimental p_inter_pr_20260528 para Busqueda Tabu Simple.

Cambios vs. ``run_tabu_simple_path_relinking_20260528.py``:
  ...
  1. **Selector p_inter probabilistico (NUEVO)**: en lugar del binario
     ...
     estado factible (analisis Seccion 12). En TS Simple PR no aporto
     ganancia visible (Delta +0.15 pp); el cambio de selector busca
     desbloquear esa mejora.
  ...
  5. **Salida**: ``experimentos/p_inter_pr_20260528_tabu_simple/``.
"""
...
SUBCARPETA      = "p_inter_pr_20260528_tabu_simple"
EXPERIMENTO_TAG = "tabu_simple_p_inter_pr"


def _ejecutar_una(tarea: TareaExp) -> tuple[TareaExp, str, dict | None, str | None]:
    """Worker: una corrida de TS Simple con la politica experimental p_inter+PR."""
    try:
...
def main() -> None:
    correr_grid(
        ...
        descripcion_cli=(
            "Variante experimental p_inter_pr_20260528 para TS Simple: "
