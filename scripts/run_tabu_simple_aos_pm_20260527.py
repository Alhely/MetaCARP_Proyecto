"""
Variante experimental aos_pm_20260527 para Busqueda Tabu Simple.
...
Cambios vs. ``run_tabu_simple_strict_intra_inter_20260524.py``:
  ...
  5. **Salida**: ``experimentos/aos_pm_20260527_tabu_simple/``.
"""
...
SUBCARPETA      = "aos_pm_20260527_tabu_simple"
EXPERIMENTO_TAG = "tabu_simple_aos_pm"


def _ejecutar_una(tarea: TareaExp) -> tuple[TareaExp, str, dict | None, str | None]:
    """Worker: una corrida de TS Simple con la politica experimental AOS PM."""
    try:
...
def main() -> None:
    correr_grid(
        ...
        descripcion_cli=(
            "Variante experimental aos_pm_20260527 para TS Simple: "
